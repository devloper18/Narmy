...
def reset_attack_limit(message):
    owner_id = 2109683176  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [𝐏𝐤 𝐂𝐡𝐨𝐩𝐫𝐚](https://t.me/@Pk_Chopra) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002215875563"  # Replace with your actual feedback channel ID
